<main class="flex-grow">
    ...
    <section class="w-full sm:w-[70%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4">
        ...
        <article class="bg-white rounded-2xl shadow hover:shadow-lg transition p-4 flex flex-col">
            ...
            <p class="text-gray-600 mb-4 text-sm">Sculpture en bois d’ébène, pièce unique réalisée par un artisan local.</p>
            <a class="mt-auto bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition font-semibold" href="product.html">voir</a>
        </article>
        <!-- Produit 3 -->
        <article class="bg-white rounded-2xl shadow hover:shadow-lg transition p-4 flex flex-col">
            ...
            <p class="text-gray-600 mb-4 text-sm">Tenue traditionnelle en pagne wax, disponible en plusieurs tailles.</p>
            <a class="mt-auto bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition font-semibold" href="product.html">voir</a>
        </article>
        <!-- Produit 4 -->
        <article class="bg-white rounded-2xl shadow hover:shadow-lg transition p-4 flex flex-col">
            ...
            <p class="text-gray-600 mb-4 text-sm">Poterie fabriquée à la main, idéale pour la décoration intérieure.</p>
            <a class="mt-auto bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition font-semibold" href="product.html">voir</a>
        </article>
    </section>
