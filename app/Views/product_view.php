<main class="flex-grow">
        ...
        <div class="bg-gray-50 rounded-2xl p-6 shadow">
            ...
            <div class="space-y-3">
                <?php foreach ($comments as $comment): ?>
                    <div class="bg-white rounded-xl p-4 shadow flex flex-col sm:flex-row gap-2 mt-4">
                        <span class="font-bold text-green-700"><?= htmlspecialchars($comment['first_name'] . ' ' . $comment['last_name']) ?></span>
                        <span class="text-gray-600"><?= htmlspecialchars($comment['content']) ?></span>
                    </div>
                <?php endforeach; ?>
    ...
    <textarea name="comment" required
              ...
              class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 resize-none mb-2"></textarea>
    <button type="submit"
